...
@interface TKDetailDataCell ()
@property (nonatomic,strong) UIImageView *lineImageView;
@end
@implementation TKDetailDataCell
...
- (void) layoutSubviews {
    ...
    CGSize size=[_labName.text textSize:_labName.font withWidth:self.frame.size.width];
    r.size=size;
